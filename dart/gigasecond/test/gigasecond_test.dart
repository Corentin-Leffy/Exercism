  ...
  group('Add one gigasecond to the input. ', () {
    test('date only specification of time', () {
      ...
      DateTime expectedDate =
          new DateTime.utc(2043, DateTime.january, 1, 1, 46, 40);
    ...
    test('second test for date only specification of time', () {
      ...
      final DateTime result = Gigasecond().add(birthDate);
      DateTime expectedDate =
          new DateTime.utc(2009, DateTime.february, 19, 1, 46, 40);
    ...
    test('third test for date only specification of time', () {
      ...
      final DateTime result = Gigasecond().add(birthDate);
      DateTime expectedDate =
          new DateTime.utc(1991, DateTime.march, 27, 1, 46, 40);
    ...
    test('full time specified', () {
      final DateTime birthDate =
          new DateTime.utc(2015, DateTime.january, 24, 22, 00, 00);
      final DateTime result = Gigasecond().add(birthDate);
      DateTime expectedDate =
          new DateTime.utc(2046, DateTime.october, 2, 23, 46, 40);
    ...
    test('full time with day roll-over', () {
      final DateTime birthDate =
          new DateTime.utc(2015, DateTime.january, 24, 23, 59, 59);
      final DateTime result = Gigasecond().add(birthDate);
      DateTime expectedDate =
          new DateTime.utc(2046, DateTime.october, 3, 01, 46, 39);
